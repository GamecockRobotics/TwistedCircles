...
int odometry() {
	...
	while (true) {
		...
		pros::lcd::set_text(5, "x: " + std::to_string(x_loc));
		pros::lcd::set_text(6, "y: " + std::to_string(y_loc));	
		pros::lcd::set_text(7, "theta: " + std::to_string(theta));
...
void opcontrol() {
	...
	while (true) {
		...
		// int right_speed = power - turn; 
		// int left_Speed = power + turn; 
